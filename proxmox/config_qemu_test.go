...
func Test_ConfigQemu_mapToApiValues(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Create Disks.Ide.Disk_X.Disk All",
			...
			output: map[string]interface{}{"ide0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_rd_max_length=3,iops_wr=23,iops_wr_max=89,iops_wr_max_length=4,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=558485ef-478,ssd=1"},
		},
		...
		{name: "Create Disks.Sata.Disk_X.Disk ALL",
			...
			output: map[string]interface{}{"sata0": "Test:32,aio=native,cache=unsafe,discard=on,format=qcow2,iops_rd=34,iops_rd_max=78,iops_rd_max_length=3,iops_wr=23,iops_wr_max=89,iops_wr_max_length=4,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,serial=ab_C-12_3,ssd=1"},
		},
		...
		{name: "Create Disks.Scsi.Disk_X.Disk All",
			...
			output: map[string]interface{}{"scsi0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_rd_max_length=3,iops_wr=23,iops_wr_max=89,iops_wr_max_length=4,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=558485ef-478,ssd=1"},
		},
		...
		{name: "Create Disks.VirtIO.Disk_X.Disk All",
			...
			output: map[string]interface{}{"virtio0": "Test:32,aio=native,cache=directsync,discard=on,format=raw,iops_rd=34,iops_rd_max=78,iops_rd_max_length=3,iops_wr=23,iops_wr_max=89,iops_wr_max_length=4,iothread=1,mbps_rd=10.30,mbps_rd_max=99.20,mbps_wr=45.23,mbps_wr_max=79.23,ro=1,serial=558485ef-478"},
		},
		...
		{name: "Update Disk.Ide.Disk_X.Disk CHANGE",
		...
		{name: "Update Disk.Ide.Disk_X.Disk MIGRATE",
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE DOWN",
		...
		{name: "Update Disk.Ide.Disk_X.Disk RESIZE UP",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_3: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    10,
		...
		{name: "Update Disk.Ide.Disk_X.Disk.Format CHANGE",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Ide: &QemuIdeDisks{Disk_1: &QemuIdeStorage{Disk: &QemuIdeDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    10,
		...
		{name: "Update Disk.Sata.Disk_X.Disk CHANGE",
		...
		{name: "Update Disk.Sata.Disk_X.Disk MIGRATE",
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE DOWN",
		...
		{name: "Update Disk.Sata.Disk_X.Disk RESIZE UP",
		...
		{name: "Update Disk.Sata.Disk_X.Disk.Format CHANGE",
			currentConfig: ConfigQemu{Disks: &QemuStorages{Sata: &QemuSataDisks{Disk_3: &QemuSataStorage{Disk: &QemuSataDisk{
				Format:  QemuDiskFormat_Raw,
				Id:      23,
				Size:    10,
		...
		{name: "Update Disk.Scsi.Disk_X.Disk CHANGE",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk MIGRATE",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE DOWN",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk RESIZE UP",
		...
		{name: "Update Disk.Scsi.Disk_X.Disk.Format CHANGE",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk CHANGE",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk MIGRATE",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE DOWN",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk RESIZE UP",
		...
		{name: "Update Disk.VirtIO.Disk_X.Disk.Format CHANGE",
