...
import (
	...
	_ "github.com/TheGameProfi/proxmox-api-go/cli/command/commands"
	"github.com/TheGameProfi/proxmox-api-go/proxmox"
	storagesubtests "github.com/TheGameProfi/proxmox-api-go/test/cli/Storage/storage-sub-tests"
)
